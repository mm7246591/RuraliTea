...
<template>
  <div class="flex flex-col justify-center items-center">
    ...
    <div class="flex lg:w-[80vw] lg:my-[2vh]">
      <div class="flex flex-col">
        ...
        <div class="flex flex-col lg:w-[45vw] lg:mx-[2vw] lg:my-[2vh]">
          <div class="bg-[#8AA899] text-[#FAFAFA] lg:py-[2vh] lg:px-[2vw] text-lg">寄送方式（僅超商貨到付款）</div>
          <div class="bg-[#FAFAFA] lg:pb-[4vh] lg:px-[2vw]">
            <div class="flex lg:mx-[1vw] lg:my-[2vh]">
              ...
              <label for="seven"
                ...
                class="flex items-center lg:w-full lg:px-[1vw] lg:mx-[1vw] lg:h-[5vh] rounded-md border-2 border-[#8AA899]">7-ELEVEN（統一超商）</label>
            </div>
            <div class="flex lg:mx-[1vw] lg:my-[2vh]">
              ...
              <label for="family"
                ...
                class="flex items-center lg:w-full lg:px-[1vw] lg:mx-[1vw] lg:h-[5vh] rounded-md border-2 border-[#8AA899]">全家便利商店</label>
            </div>
          </div>
        </div>
        <div class="flex flex-col lg:w-[45vw] lg:mx-[2vw] lg:my-[2vh]">
          <div class="bg-[#8AA899] text-[#FAFAFA] lg:py-[2vh] lg:px-[2vw] text-lg">收件資訊</div>
          <div class="bg-[#FAFAFA] lg:pb-[4vh] lg:px-[2vw]">
            <div class="flex justify-evenly lg:mx-[1vw] lg:my-[2vh]">
            ...
            <div class="flex justify-end lg:mx-[1vw]">
              <input type="checkbox" id="same" name="same" v-model="sameInfo" />
              <label for="same" class="lg:mx-[.5vw] text-[#9E9E9E]">收件資訊同聯絡資訊</label>
            </div>
          </div>
        </div>
      </div>
